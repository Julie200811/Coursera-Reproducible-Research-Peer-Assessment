...
hist(daily_steps$steps,xlab="Number of Steps",col="light blue",main="Total Steps by Day",ylim=c(0,45))
dev.copy(png,'total_steps_hist01.png')
dev.off()
...
dev.copy(png,'time_series02.png')
dev.off()
...
dev.copy(png,'total_steps02.png')
dev.off()
